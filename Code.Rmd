...
# increasing capacity by 23,191.65 people increases the odds of winning at home by 3.1 times for baseball
exp(1.15213)
exp(1.15213 +  1.05472) # basketball increasing capacity increases the odds of winning by 9 times
exp(1.15213 +  -0.79504) # football increasing capacity increases the odds of winning by 40%
exp(1.15213 +  0.84660) # hockey increasing capacity increases the odds of winning by 7.38 times


# Type Sport Interpretations
exp(2.39147) # basketball has 10.9 times more likely to win in home court than baseball
exp(-0.79504) # football is 55% less likely to win in home court than baseball
exp(-3.19599) # hockey is 96% less likely to win in home court than baseball

# makes sense because baseball stadiums are all different shapes, maybe hockey you cannot hear fans, football there are less games, so it's harder to win as many

# Attendence Interpretations
sd(AllData$Attendence)

# increasing attendance by 18.12 percent decreases the odds of winning at home by 5.5% but this changes based on sport and capacity. So if Baseball is the baseline, 5.5%
exp(-0.05649)
exp(-0.05649+0.28592) # basketball 25% increase
exp(-0.05649+-0.79504) # football 57.3% decrease
exp(-0.05649+0.84660) # hockey is 2.2 times increase

# interaction between capacity and attendance
exp(0.59470) # 1.8 times more, so increase one and the effect of the other increases by 80%
...
# increasing a state's population by 11,921,447 decreases the odds of a home win by 61% but don't forget about interaction
exp(-0.95183)

# interaction is 23% increase, so increases happiness effect by 23%
exp(0.21211)

# happy interpretation
# increasing happiness by 1, increases odds of winning at home by 16%
exp(0.15521)
