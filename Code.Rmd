...
AllData$State1 <- as.factor(AllData$State1)
...
sports.glmerNone <- glmer(WinPct~1+(1|State),family=binomial,weights=HomeGames,data=AllData)
summary(sports.glmerNone)

sports.glmer <- glmer(WinPct~Capacity2+Attendence2+Type+FranchiseValue2+Year.opened2+Population2+Trump.Vote2+Happiness+(1|State1),family = binomial,data=AllData,weights=HomeGames)

sports.glmerFULL <- glmer(WinPct~Capacity2+Attendence2+Type+FranchiseValue2+Year.opened2+Capacity2:Attendence2+Type:FranchiseValue2+Year.opened2:Type+Type:Attendence2+FranchiseValue2:Attendence2+Type:Capacity2+(Population2+Trump.Vote2+Happiness)^2+Happiness:Capacity2+Trump.Vote2:Attendence2+Happiness:Type+Population2:Year.opened2+Happiness:Year.opened2+(1|State1),family=binomial,data=AllData,weights=HomeGames)
